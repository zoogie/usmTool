...
APP_TITLE		:= usmTool v1.0
APP_DESCRIPTION		:= unSAFE_MODE installer and more
APP_AUTHOR		:= Zoogie
...
# CIA
APP_PRODUCT_CODE 	:= SLOT
APP_UNIQUE_ID 		:= 0x1122D
...
export VPATH	:=	$(foreach dir,$(SOURCES),$(CURDIR)/$(dir)) \
			...
			$(foreach dir,$(DATA),$(CURDIR)/$(dir)) $(UMSDIR)/stage1
...
clean:
	@echo clean ...
	@rm -fr $(BUILD) $(TARGET).3dsx $(TARGET).cia $(OUTPUT).smdh $(TARGET).elf $(GFXBUILD) slotTol.bin
